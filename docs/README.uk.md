...
Gyazo — це сервіс для швидкого збереження й поширення скріншотів та візуальних нотаток із постійними посиланнями, пошуком через OCR і тегами, тому його зручно використовувати як зовнішню візуальну памʼять у щоденній роботі; дивись [gyazo.com](https://gyazo.com) і [документацію Gyazo API](https://gyazo.com/api/docs).
